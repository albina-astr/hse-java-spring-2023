...
| Пустотин Даниил, <br> Анашкин Илья, <br> Чуканов Тимофей | Генератор коротких текстов | TBD | TBD | TBD | TBD |
| Эмиль Карачик (@ekarachik), <br> Анжелика Дашкевич (@Angela3214), <br> Ксения Карпенко (@nehikka), <br> Александр (@aleksander_lit) | Экстрактор метаданных и текста из файлов для быстрого поиска | TBD | TBD | TBD | TBD |
| Гудзь Михаил, <br> Петров Дамир | Клоны текстовых утилит Unix | TBD | TBD | TBD | TBD |
